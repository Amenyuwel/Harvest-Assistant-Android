...
public class MainActivityFAQ extends AppCompatActivity {
    ...
    private void prepareListData() {
        ...
        listDataHeader.add("How to be verified farmer in General Santos City?");
        listDataHeader.add("How to use the camera feature");
        listDataHeader.add("How to use the Calendar Activity");
